...
HOMSAP.CDS.url <- "homo_sapiens/cds/Homo_sapiens.GRCh38.cds.all.fa.gz"
#set Pan troglodytes CDS URL
PANTRO.CDS.url <- "pan_troglodytes/cds/Pan_troglodytes.Pan_tro_3.0.cds.all.fa.gz"
#get Homo sapiens CDS
HOMSAP.cds.file <- tempfile()
curl::curl_download(paste0(ensembl, HOMSAP.CDS.url), HOMSAP.CDS.file)
HOMSAP.cds <- Biostrings::readDNAStringSet(HOMSAP.CDS.file)
#get Pan troglodytes CDS
PANTRO.cds.file <- tempfile()
curl::curl_download(paste0(ensembl, PANTRO.CDS.url), PANTRO.CDS.file)
...
ARATHA.GFF.url <- paste0("gff3/arabidopsis_thaliana/",
...
curl::curl_download(paste0(ensemblPlants, ARATHA.GFF.url), ARATHA.GFF.file.gz)
