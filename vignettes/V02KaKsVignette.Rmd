...
A plotting function `plot.dagchainer()` is integrated and can be directly applied on the DAGchainer results.
...
A plotting function `plot.kaks()` is integrated and can be applied on the Ka/Ks results. 
