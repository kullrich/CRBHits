...
![Figure: Overview of the `cds2rbh()` function](cds2rbhoverview.png){width=600px}
...
![Figure: Individual steps of the `cds2rbh()` function](cds2rbh.png){width=600px}
...
![Figure: Overview of the `rbh2kaks()` function steps](rbh2kaksoverview.png){width=600px}
