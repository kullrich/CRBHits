#' @title cdsfile2rbh
#' @name cdsfile2rbh
#' @description This function calculates (conditional-)reciprocal best hit (CRBHit) pairs from two two CDS fasta file's.
...
#' @param lastpath specify the PATH to the last binaries [default: /extdata/last-1168/src/]
...
#' @examples
#' ## compile last-1168 within CRBHits
#' make_last()
