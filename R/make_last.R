#' @title make_last
#' @name make_last
#' @description This function tries to build the prerequisite last-1168 from source code forked within CRBHits
...
make_last <- function(){
  ...
  if(!dir.exists(lastpath)){
    ...
    system(paste0("unzip last-1168.zip"))
    setwd(paste0(find.package("CRBHits"), "/extdata/last-1168/"))
  }
