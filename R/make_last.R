#' @title make_last
#' @name make_last
#' @description This function tries to build the prerequisite last-1595 from
...
make_last <- function(){
    ...
    if(!dir.exists(lastpath)){
        ...
        system2(command="unzip", args="last-1595.zip")
        setwd(paste0(find.package("CRBHits"), "/extdata/last-1595/"))
    }
