#' @title make.vignette
#' @name make.vignette
#' @description This function tries to build the prerequisite last-1060 and KaKs_calculator2.0 from source code forked within CRBHits
...
make.vignette <- function(){
  ...
  return(c(paste0(LastTempDir, "/last-1060/src/"),
