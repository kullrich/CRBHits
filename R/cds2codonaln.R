...
#' a global alignment and converts this alignment back into a codonalignment.
...
cds2codonaln <- function(cds1, cds2,
    ...
    #xy.aln <- Biostrings:::.makePostalignedSeqs(
    #Biostrings::pairwiseAlignment(x.aa, y.aa, type=type,
