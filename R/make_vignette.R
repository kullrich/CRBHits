#' @title make_vignette
#' @name make_vignette
#' @description This function tries to build the prerequisite last-1256 and KaKs_calculator2.0 from source code forked within CRBHits
...
make_vignette <- function(){
  ...
  LastTempDir <- tempdir()
  system(paste0("unzip -o ", CRBHits_root, "/extdata/last-1256.zip -d ", LastTempDir))
  ...
  return(c(paste0(LastTempDir, "/last-1256/bin/"),
