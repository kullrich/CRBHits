#' @title make_vignette
#' @name make_vignette
#' @description This function tries to build the prerequisite last-1168 and KaKs_calculator2.0 from source code forked within CRBHits
...
make_vignette <- function(){
  ...
  LastTempDir <- tempdir()
  system(paste0("unzip -o ", CRBHits_root, "/extdata/last-1168.zip -d ", LastTempDir))
  system(paste0("cd ", LastTempDir, "/last-1168/; make"))
  ...
  return(c(paste0(LastTempDir, "/last-1168/src/"),
